    ...
    useEffect(() => {
        const fetchLogs = async () => {
            try {
                ...
                console.error("Gagal mengambil riwayat log aktivitas", error);
            } finally {
                setLoading(false);
            }
        };
        ...
        <div>
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">Daftar seluruh jejak aktivitas pengguna dan sistem.</p>
                </div>
            </div>

            <Card title="Seluruh Aktivitas Sistem">
                {loading ? (

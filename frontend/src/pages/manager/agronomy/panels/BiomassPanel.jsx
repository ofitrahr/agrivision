...
const BiomassPanel = ({ statsData, statsLoading, farm }) => {
  ...
  return (
    <div className="agro-panel agro-panel-left">
      <h2 style={{ fontSize: 16, marginTop: 0, marginBottom: 16, color: '#116a3a' }}>Biomassa Karbon</h2>
      <DistributionChart histogram={statsData?.histogram} loading={statsLoading} layerLabel="Biomassa" />
      <AnomalyWarning anomaly={statsData?.anomaly} anomalyHa={anomalyHa} anomalyPercent={statsData?.anomaly?.percent ?? 0} selectedLayer="Biomassa" />
